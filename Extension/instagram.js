...
//         (CurrentUser.user_pic_url = "icon.png"),
...
//       ? ((d = new User(a.username, "-1", a.username, "icon.png", 0)),
...
// Main entry point
import InstagramController from "./src/controllers/InstagramController";

// Instantiate and initialise the instagram controller
