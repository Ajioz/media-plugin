...
//                     buttons[jj].getAttribute("aria-label").includes("reaction")
//                   ) {
//                     buttons[jj].click();
//                     break;
//                   }
...
// Pinterest Entry point
import PinterestController from "./src/controllers/PinterestController";

const pinController = new PinterestController();
pinController.init();
