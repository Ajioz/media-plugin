...
$(document).on("click", "#add-filter", function (event) {
  ...
  for (var kk = 0; kk < IdealTargets.length; kk++) {
    ideal_targets_string +=
      IdealTargets[kk].username +
      " followers: " +
      IdealTargets[kk].followers +
      "<br> ";
  }
...
$(document).on("click", "#add-blacklist", function (event) {
  var new_blacklist = prompt(
    "Please enter a username exactly to add it to the blacklist:"
  );
  if (new_blacklist && new_blacklist.includes(",")) {
    var split = new_blacklist.split(",");
    for (var kk = 0; kk < split.length; kk++) {
...
$(document).ready(function () {
  ...
  $("#sidebar-home-tinder2").click(function () {
    ...
    $(".content-wrapper").load("tinder.html", function () {
      ...
      if (
        user_plan == "lifetime" ||
        user_plan == "linkstories" ||
        user_plan == "instoo2" ||
        user_plan == "linkyear" ||
        user_plan == "instoogold" ||
        user_plan == "instooyearly" ||
        user_plan == "instoopro" ||
        user_plan == "instoogold2"
      ) {
        speed_limit = 300;
      ...
      $("#comment_tags").on("itemAdded", function (event) {
        ...
        if (tagWidth > tagsinputWidth) {
          ...
          $("#comment_tags")
            ...
            .find(".bootstrap-tagsinput span.tag")
            .last()
            .html(res + "..." + '<i class="fas fa-times"></i>');
        }
      ...
      $("#customRangeTinderComments").change(function () {
        ...
        var follow_tinder_speed = parseInt(
          $("#customRangeTinderComments").val()
        );

        $("#comment_tinder_set").html(
          "DMs/day: " + $("#customRangeTinderComments").val()
        );
      ...
      $("#customRangeTinderLikes").change(function () {
        ...
        $("#like_tinder_set").html(
          "Likes/day: " + $("#customRangeTinderLikes").val()
        );
  ...
  $("#sidebar-home-crm").click(function () {
    ...
    $(".content-wrapper").load("crm.html", function () {
      ...
      $("#validateFollowers").click(function () {
        var followers_list = prompt(
          "Enter a comma seperated list of followers to rank targets[dogs, dogsofinstagram, dog]:"
        );
      ...
      $("#validateSales").click(function () {
        var sales_list = prompt(
          "Enter a comma seperated list of sales to rank targets(dogs, 10, dogsofinstagram, 20, dog, 30):"
        );
        ...
        for (var kk = 0; kk < instagram_data.length; kk++) {
          if (splits.includes(instagram_data[kk].username)) {
            instagram_data[kk].sales += parseFloat(
              splits[splits.indexOf(instagram_data[kk].username) + 1]
            );
          }
        }
        for (var kk = 0; kk < linkedin_data.length; kk++) {
          if (splits.includes(linkedin_data[kk].username)) {
            linkedin_data[kk].sales += parseFloat(
              splits[splits.indexOf(linkedin_data[kk].username) + 1]
            );
          }
        }
  ...
  $("#sidebar-home-link2").click(function () {
    ...
    $(".content-wrapper").load("linkedin.html", function () {
      ...
      $("#media_tags").on("itemAdded", function (event) {
        ...
        var tagWidth = $("#media_tags")
          .parent()
          .find(".bootstrap-tagsinput span.tag")
          .last()
          .width(); // To get the Width of individual Tag.
        if (tagWidth > tagsinputWidth) {
      ...
      $("#media_tags").on("itemRemoved", function (event) {
        ...
        for (var kk = 0; kk < split_tags.length; kk++) {
          SendMessage(
            "RemoveTagFromListLinkedin",
            "TagName",
            split_tags[kk].split("#").join("")
          );
      ...
      $("#customRangeLinkedinFollows").change(function () {
        ...
        var follow_Linkedin_speed = parseInt(
          $("#customRangeLinkedinFollows").val()
        );
        var like_Linkedin_speed = parseInt($("#customRange3").val());

        $("#follow_Linkedin_set").html(
          "Follows/day: " + $("#customRangeLinkedinFollows").val()
        );

        SendMessage(
          "UpdateLinkedinFollowLimit",
          "limit",
          follow_Linkedin_speed
        );
      });
      ...
      $("#customRangeLinkedinLikes").change(function () {
        ...
        var like_Linkedin_speed = parseInt(
          $("#customRangeLinkedinLikes").val()
        );

        $("#like_Linkedin_set").html(
          "Likes/day: " + $("#customRangeLinkedinLikes").val()
        );
  ...
  $("#sidebar-home-tiktok").click(function () {
    ...
    $(".content-wrapper").load("tiktok.html", function () {
      ...
      $("#customRangeTikTokFollows").change(function () {
        ...
        var follow_tiktok_speed = parseInt(
          $("#customRangeTikTokFollows").val()
        );
        var like_tiktok_speed = parseInt($("#customRange3").val());

        $("#follow_tiktok_set").html(
          "Follows/day: " + $("#customRangeTikTokFollows").val()
        );
      ...
      $("#customRangeTikTokLikes").change(function () {
        ...
        $("#like_tiktok_set").html(
          "Likes/day: " + $("#customRangeTikTokLikes").val()
        );
  ...
  $("#sidebar-home-facebook").click(function () {
    ...
    $(".content-wrapper").load("facebook.html", function () {
      ...
      $("#customRangefacebookFollows").change(function () {
        ...
        var follow_facebook_speed = parseInt(
          $("#customRangefacebookFollows").val()
        );
        var like_facebook_speed = parseInt($("#customRange3").val());

        $("#follow_facebook_set").html(
          "Friends/day: " + $("#customRangefacebookFollows").val()
        );

        SendMessage(
          "UpdatefacebookFollowLimit",
          "limit",
          follow_facebook_speed
        );
      });
      ...
      $("#customRangefacebookLikes").change(function () {
        ...
        var like_facebook_speed = parseInt(
          $("#customRangefacebookLikes").val()
        );

        $("#like_facebook_set").html(
          "Likes/day: " + $("#customRangefacebookLikes").val()
        );
  ...
  $("#sidebar-home-pinterest").click(function () {
    ...
    $(".content-wrapper").load("pinterest.html", function () {
      ...
      $("#customRangePinterestFollows").change(function () {
        ...
        var follow_pinterest_speed = parseInt(
          $("#customRangePinterestFollows").val()
        );
        var like_pinterest_speed = parseInt($("#customRange3").val());

        $("#follow_pinterest_set").html(
          "Follows/day: " + $("#customRangePinterestFollows").val()
        );

        SendMessage(
          "UpdatePinterestFollowLimit",
          "limit",
          follow_pinterest_speed
        );
      });
      ...
      $("#customRangePinterestLikes").change(function () {
        ...
        var like_pinterest_speed = parseInt(
          $("#customRangePinterestLikes").val()
        );

        $("#like_pinterest_set").html(
          "Likes/day: " + $("#customRangePinterestLikes").val()
        );
  ...
  $("#sidebar-home-tw").click(function () {
    ...
    $(".content-wrapper").load("twitter.html", function () {
      ...
      $("#customRangeTwitterFollows").change(function () {
        ...
        var follow_Twitter_speed = parseInt(
          $("#customRangeTwitterFollows").val()
        );
        var like_Twitter_speed = parseInt($("#customRange3").val());

        $("#follow_Twitter_set").html(
          "Retweets/day: " + $("#customRangeTwitterFollows").val()
        );
      ...
      $("#customRangeTwitterLikes").change(function () {
        ...
        $("#like_Twitter_set").html(
          "Likes/day: " + $("#customRangeTwitterLikes").val()
        );
  ...
  $("#sidebar-home").click(function () {
    ...
    $(".content-wrapper").load("home.html", function () {
        ...
        for (
          ...
          if (index >= 0) {
            ...
            if (
              ...
              (chart_data.length < 2 ||
                Math.abs(
                  parseInt(obj.followers) - chart_data[chart_data.length - 1]
                ) < 200)
            ) {
              chart_data.push(parseInt(obj.followers));
              if (obj.followers > max) {
      ...
      $("#media_accounts").on("itemAdded", function (event) {
        ...
        for (var kk = 0; kk < split_tags.length; kk++) {
          if (
            ...
            if (
              account_name.match(/^[0-9a-z._]+$/) ||
              account_name.includes(".") ||
              account_name.includes("_")
            ) {
      ...
      $("#customRange5").change(function () {
        ...
        settings.FollowSettings.TimeMin = Math.floor(
          (16 * 60 * 60) / parseInt(settings.FollowSettings.TimeMin)
        );
        settings.FollowSettings.TimeMax =
          Math.floor(
            (16 * 60 * 60) / parseInt(settings.FollowSettings.TimeMin)
          ) + 10;
        settings.FollowSettings.ErrorTime = 200;

        settings.UnfollowSettings.TimeMin = Math.floor(
          (16 * 60 * 60) / parseInt(settings.UnfollowSettings.TimeMin)
        );
        settings.UnfollowSettings.TimeMax =
          Math.floor(
            (16 * 60 * 60) / parseInt(settings.UnfollowSettings.TimeMin)
          ) + 10;
        ...
        settings.LikeSettings.TimeMin = Math.floor(
          (16 * 60 * 60) / parseInt(settings.LikeSettings.TimeMin)
        );
        settings.LikeSettings.TimeMax = like_speed + 10;
        settings.LikeSettings.ErrorTime = 200;

        settings.StorySettings.TimeMin = Math.floor(
          (16 * 60 * 60) / parseInt(settings.StorySettings.TimeMin)
        );
        settings.StorySettings.TimeMax = story_speed + 10;
  ...
  function onClick(e) {
    $("#snapshots").html(
      "<h4>Settings Used:</h4> <br>Likes/Day:" +
        live_snapshots[e.dataPoint.x].LikeSettings.TimeMin +
        "<br>Follows/day:" +
        live_snapshots[e.dataPoint.x].FollowSettings.TimeMin +
        "<br>Unfollows/Day:" +
        live_snapshots[e.dataPoint.x].UnfollowSettings.TimeMin +
        "<br>"
    );
    $("#tags").html(
      "<h4>Hashtag Targets:</h4> <br>" + live_tags[e.dataPoint.x]
    );
    $("#accounts").html(
      "<h4>Account Targets:</h4> <br>" + live_accounts[e.dataPoint.x]
    );
  }
  ...
  $("#sidebar-settings").click(function () {
    ...
    $(".content-wrapper").load("settings.html", function () {
      ...
      $("#filters").html(
        "<br>Words to avoid in bio text and photo content:  <br>" +
          filter_string
      );
      ...
      $("#switch-account").click(function () {
        ...
        alert(
          "Please wait 30 seconds while the Instagram tab navigates to your new profile. Make sure to log into the correct account at Instagram.com first. You can also re-install the extension to switch accounts."
        );
      });
      ...
      $("#generateHashtags").click(function () {
        ...
        $.ajax({
          ...
          $("#hashtagsOutput").append(
            "<h3>Best hashtags based on our logs:" + dataobj + "</h3>"
          );
        });
      });
...
function SaveSettings() {
  ...
  settings.CollectFollowings.Interval = $(
    "#input-following-collect-time"
  ).val();
  ...
  if (licenseStatus) {
    if (licenseStatus === "Full") {
      ...
      extensionIconSettings(
        ...
        "",
        window.localStorage.getItem("daysLeftInappnameTrial") +
  ...
  if (license.result && license.accessLevel == "FULL") {
    ...
    if (daysAgoLicenseIssued <= TRIAL_PERIOD_DAYS) {
      window.localStorage.setItem(
        "daysLeftInCGTrial",
        TRIAL_PERIOD_DAYS - daysAgoLicenseIssued
      );
...
function ProcessFilteredFollowings(users) {
  ...
  for (var i = 0; i < users.length; i++) {
    ...
    var userRow =
      `
    <li class="add-whitelist-user" user_id=` +
      user.user_id +
      `>
    <div class="row">
    <div class="col-md-2"> ` +
      ...
      user.user_pic_url +
      `'/></a></div>
    <div class='col-md-5 align-mid-vertical text-instafollow-td'>` +
      user.username +
      `</div><div class='col-md-5 text-instafollow-td align-mid-vertical'>` +
      user.full_name +
      `</div>
    </div>
    </li>
...
function AddedWhitelistUsers(users) {
  ...
  for (var i = 0; i < users.length; i++) {
    ...
    <button class="btn-danger remove-user-whitelist" user_id=` +
      user.user_id +
...
function UpdateCollectJobStatus(Jobs) {
  ...
  for (var i = 0; i < Jobs.length; i++) {
    ...
    <button class="btn-danger remove-user-collect" user_id='` +
        user +
        `'><i class="fas fa-times"></i></button></td>
    <td class='align-mid-vertical text-instafollow-td'><a href='https://www.instagram.com/` +
        user +
        `/' target='_blank'>@
    ` +
        user +
...
function OnLikedMediaLinkedin(media) {
  ...
  var mediaRow =
    `
  <tr>
  <td><a href='https://linkedin` +
    media.url.split("linkedin")[1] +
    `' target='_blank'><img class='backup_picture img-rounded' width='64' height='64'   src='` +
    media.img +
    `'/></a></td>
  <td class='align-mid-vertical text-instafollow-td'>` +
